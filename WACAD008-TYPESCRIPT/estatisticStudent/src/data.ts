...
let alunoEditando: Aluno | null = null; // Variável para armazenar o aluno que está sendo editado
...
function atualizarEstatisticas() {
  (document.getElementById("numAlunos") as HTMLElement).textContent =
    turma.getNumAlunos().toString();
  (document.getElementById("mediaIdade") as HTMLElement).textContent =
    turma.getMediaIdades().toString();
  (document.getElementById("mediaAltura") as HTMLElement).textContent =
    turma.getMediaAlturas().toString();
  (document.getElementById("mediaPeso") as HTMLElement).textContent =
...
function renderizarListaAlunos() {
  ...
  turma.getAlunos().forEach(aluno => {
    ...
    btnEditar.addEventListener("click", () => {
      ...
      (document.getElementById("adicionar") as HTMLButtonElement)!.textContent = "Salvar";
